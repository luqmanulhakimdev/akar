...
<!--        <link href="https://raw.githubusercontent.com/samrayner/bootstrap-side-navbar/gh-pages/assets/stylesheets/navbar-fixed-side.css" rel="stylesheet" />-->
    ...
    <script type="text/javascript">
        ...
        var serverTime = new Date(<?= mdate('%Y, %m, %d, %H, %i, %s, 0') ?>);
        ...
        function displayServerTime(){
            ...
            document.getElementById("time").innerHTML = "Jam : " +(sh.length==1?"0"+sh:sh) + ":" + (sm.length==1?"0"+sm:sm) + ":" + (ss.length==1?"0"+ss:ss);
        }
        
    </script>
   
    <body onload="setInterval('displayServerTime()', 1000);" style="padding-top: 70px;">
